...
import './userdatastyles/usertablerow1.css';

function UserTableRow1( {user} ) {
  ...
  return (
    <>
        ...
        <article className='specialcell'>
            {user.action_taken[0]}<br/>
            { 
                (user.action_taken).length > 1 && <span>{user.action_taken[1]}</span>
            }
        </article>
    </>
  )
